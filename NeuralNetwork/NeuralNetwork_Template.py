...
def forwardPass(W1, b1, W2, b2, X):
    ...
    A1 = (W1@X)+b1
    ## H1 = ?? (Remember tanh function. NumPy provides an np.tanh function)
    H1 = np.tanh(A1)
    # print("H1: ", H1.shape)
    ...
    A2 = (W2@H1)+b2
    #H2 = ?? (Remember this is a Sigmoid activation function)
    H2 = logistic(A2)
    return H2, H1
    # return 0, 0
...
def gradient_descent(X, Y, W1, b1, W2, b2, learning_rate):
    ...
    for i in range(0, num_iterations):
        ...
        #  Adjust the following to implement your gradient descent update rule below.
...
def runNeuralNetwork(X, Y):
    ...
    #  Specify the correct shape for the W1 and W2 matrix
    # and for b1 and b2
